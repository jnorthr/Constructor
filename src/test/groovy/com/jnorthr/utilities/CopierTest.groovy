...
class Copier extends spock.lang.Specification {
	...
	def setup() 
	{
		...
		String outn = home + fs + "Dropbox" + fs + "SkeletonMaker" + fs + "temp" + fs + "samples";
		test = new Copier();
	}          
	...
	def cleanupSpec() 
	{
		println "end of testing for Copier"
	}   
 
  	def "Build default Copier"() {
  		when:     'default Copier has been built'
		then:     test != null;
