...
class GitHandlerTest extends spock.lang.Specification {
    GitHandlerTest test;
	...
	def cleanupSpec() 
	{
		println "end of testing for GitHandlerTest"
	}   
 
  	def "Build default GitHandlerTest"() {
  		when:     'default GitHandlerTest has been built'
		then:     test != null;
