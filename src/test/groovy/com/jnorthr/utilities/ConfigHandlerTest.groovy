...
class ConfigHandlerTest extends spock.lang.Specification {
    	ConfigHandler test;
	...
	def cleanupSpec() 
	{
		println "end of testing for ConfigHandler"
	}   
 
  	def "Build default ConfigHandler"() {
  		when:     'default ConfigHandler has been built'
		then:     test != null;
